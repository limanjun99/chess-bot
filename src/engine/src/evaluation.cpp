...
constexpr std::array<std::array<int, 64>, 6> middlegame_values = ([]() {
  ...
  values[static_cast<size_t>(chess::PieceVariant::Bishop)] = {{
  ...
  values[static_cast<size_t>(chess::PieceVariant::King)] = {{
  ...
  values[static_cast<size_t>(chess::PieceVariant::Knight)] = {{
  ...
  values[static_cast<size_t>(chess::PieceVariant::Pawn)] = {{
      0,   0,   0,   0,   0,   0,   0,  0,   //
  ...
  values[static_cast<size_t>(chess::PieceVariant::Queen)] = {{
  ...
  values[static_cast<size_t>(chess::PieceVariant::Rook)] = {{
  ...
  int piece_values[6];
  piece_values[static_cast<size_t>(chess::PieceVariant::Bishop)] = 365;
  piece_values[static_cast<size_t>(chess::PieceVariant::King)] = 0;
  piece_values[static_cast<size_t>(chess::PieceVariant::Knight)] = 337;
  piece_values[static_cast<size_t>(chess::PieceVariant::Pawn)] = 82;
  piece_values[static_cast<size_t>(chess::PieceVariant::Queen)] = 1025;
  piece_values[static_cast<size_t>(chess::PieceVariant::Rook)] = 477;
  for (chess::PieceVariant piece :
       {chess::PieceVariant::Bishop, chess::PieceVariant::Knight,
        chess::PieceVariant::Pawn, chess::PieceVariant::Queen,
        chess::PieceVariant::Rook}) {
    for (int &value : values[static_cast<int>(piece)])
...
constexpr std::array<std::array<int, 64>, 6> endgame_values = ([]() {
  ...
  int piece_values[6];
  piece_values[static_cast<size_t>(chess::PieceVariant::Bishop)] = 297;
  piece_values[static_cast<size_t>(chess::PieceVariant::King)] = 0;
  piece_values[static_cast<size_t>(chess::PieceVariant::Knight)] = 281;
  piece_values[static_cast<size_t>(chess::PieceVariant::Pawn)] = 94;
  piece_values[static_cast<size_t>(chess::PieceVariant::Queen)] = 936;
  piece_values[static_cast<size_t>(chess::PieceVariant::Rook)] = 512;
  for (chess::PieceVariant piece :
       {chess::PieceVariant::Bishop, chess::PieceVariant::Knight,
        chess::PieceVariant::Pawn, chess::PieceVariant::Queen,
        chess::PieceVariant::Rook}) {
...
int pst::evaluate(const chess::Board &board) {
  ...
  for (const chess::PieceVariant piece :
    ...
    game_phase -= (white_pieces.count() + black_pieces.count()) *
  ...
  const int evaluation = ((middlegame_evaluation * (256 - game_phase)) +
                          endgame_evaluation * game_phase) /
                         256;
